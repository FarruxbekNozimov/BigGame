...
var ExpressHandlebars = /** @class */ (function () {
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					case 0:
						...
						partialsDirs = Array.isArray(this.partialsDir)
							? this.partialsDir
							: [this.partialsDir];
						return [
							4 /*yield*/,
							Promise.all(
								partialsDirs.map(function (dir) {
											...
											switch (_b.label) {
												case 0:
													...
													if (!dirPath && !dirTemplates) {
														throw new Error(
															"A partials dir must be a string or config object"
														);
													}
													_a = dirTemplates;
				...
				switch (_a.label) {
					...
					case 1:
						...
						cache[filePath] = this._getFile(filePath, {
							...
							var compileTemplate = (
								options.precompiled
									? _this._precompileTemplate
									: _this._compileTemplate
							).bind(_this);
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					...
					case 1:
						...
						runtimeOptions = __assign(
							__assign({}, this.runtimeOptions),
							options.runtimeOptions
						);
						data = __assign(__assign({}, options.data), {
							exphbs: __assign(__assign({}, options), {
								filePath: filePath,
								helpers: helpers,
								partials: partials,
						...
						html = this._renderTemplate(
							template,
							context,
							__assign(__assign({}, runtimeOptions), {
								data: data,
								helpers: helpers,
								partials: partials,
							})
	...
	ExpressHandlebars.prototype.renderView = function (
		viewPath,
		options,
		callback
	) {
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							this.getPartials({ cache: options.cache, encoding: encoding }),
						];
					case 1:
						partials = __assign.apply(void 0, [
					...
					case 3:
						...
						return [
							...
							this.render(
								layoutPath,
								__assign(__assign({}, context), { body: html }),
								__assign(__assign({}, renderOptions), { layout: undefined })
							),
						];
					case 4:
						html = _b.sent();
	...
	ExpressHandlebars.prototype._precompileTemplate = function (
		template,
		options
	) {
		if (options === void 0) {
	...
	ExpressHandlebars.prototype._renderTemplate = function (
		template,
		context,
		options
	) {
	...
	ExpressHandlebars.prototype._getTemplateName = function (
		filePath,
		namespace
	) {
		if (namespace === void 0) {
	...
	ExpressHandlebars.prototype._resolveViewsPath = function (views, file) {
		...
		var absoluteViews = views.map(function (v) {
