...
var _codeGen = _interopRequireDefault(require("./code-gen"));
...
JavaScriptCompiler.prototype = {
  ...
  setupHelper: function setupHelper(paramSize, name, blockHelper) {
    ...
    var foundHelper = this.nameLookup('helpers', name, 'helper'),
        callContext = this.aliasable("".concat(this.contextName(0), " != null ? ").concat(this.contextName(0), " : (container.nullContext || {})"));
    return {
      params: params,
