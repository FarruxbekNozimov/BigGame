...
var _wrapHelper = require("./internal/wrapHelper");
...
function template(templateSpec, env) {
  ...
  if (!templateSpec || !templateSpec.main) {
    throw new _exception["default"]('Unknown template object: ' + _typeof(templateSpec));
  }
  ...
  var container = {
    ...
    lookupProperty: function lookupProperty(parent, propertyName) {
      ...
      if ((0, _protoAccess.resultIsAllowed)(result, container.protoAccessControl, propertyName)) {
        return result;
      }
  ...
  ret._setup = function (options) {
    if (!options.partial) {
      ...
      container.hooks = {};
      container.protoAccessControl = (0, _protoAccess.createProtoAccessControl)(options);
      var keepHelperInHelpers = options.allowCallsToHelperMissing || templateWasPrecompiledWithCompilerV7;
      (0, _helpers.moveHelperToHooks)(container, 'helperMissing', keepHelperInHelpers);
      (0, _helpers.moveHelperToHooks)(container, 'blockHelperMissing', keepHelperInHelpers);
    } else {
...
function passLookupPropertyOption(helper, container) {
  ...
  return (0, _wrapHelper.wrapHelper)(helper, function (options) {
    return Utils.extend({
